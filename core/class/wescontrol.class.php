	...
	private function getListeCommandes() {
		$commands = array(
			"teleinfo" => array(
				...
				"PRODUCTION" => array("name" => __("Production", __FILE__), "type" => "info", "subtype" => "numeric", "unite" => "kWh", "calcul" => "#value#/1000", "xpath" => "//tic#id#/Production", "dashboard" => "line", "mobile" => "line", "filter" => ["ticMeasure" => "production"], "order" => 39)
			),
			"general" => array(
			...
			"compteur" => array(
				...
				"consomois" => array("name" => __("Consommation mois", __FILE__), "type" => "info", "subtype" => "numeric", "unite" => ["default" => "m³", "elec" => "kWh", "cal" => "kWh"], "xpath" => "//impulsion/CONSO_MOIS#id#", "dashboard" => "line", "mobile" => "line", "filter" => ["usecustomcgx" => 1, "comptMeasure" => "consumption", "typecompt" => true], "order" => 6),
				...
				"consoannee" => array("name" => __("Consommation année", __FILE__), "type" => "info", "subtype" => "numeric", "unite" => ["default" => "m³", "elec" => "kWh", "cal" => "kWh"], "xpath" => "//impulsion/CONSO_ANNEE#id#", "dashboard" => "line", "mobile" => "line", "filter" => ["usecustomcgx" => 1, "comptMeasure" => "consumption", "typecompt" => true], "order" => 8),
				...
				"prodmois" => array("name" => __("Production mois", __FILE__), "type" => "info", "subtype" => "numeric", "unite" => ["default" => "m³", "elec" => "kWh", "cal" => "kWh"], "xpath" => "//impulsion/CONSO_MOIS#id#", "dashboard" => "line", "mobile" => "line", "filter" => ["usecustomcgx" => 1, "comptMeasure" => "production", "typecompt" => true], "order" => 6),
				...
				"prodannee" => array("name" => __("Production année", __FILE__), "type" => "info", "subtype" => "numeric", "unite" => ["default" => "m³", "elec" => "kWh", "cal" => "kWh"], "xpath" => "//impulsion/CONSO_ANNEE#id#", "dashboard" => "line", "mobile" => "line", "filter" => ["usecustomcgx" => 1, "comptMeasure" => "production", "typecompt" => true], "order" => 8),
