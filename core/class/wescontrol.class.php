	...
	private function getListeCommandes() {
		$commands = array(
			"teleinfo" => array(
				...
				"HCHC" => array("name" => __("Index (HC)", __FILE__), "type" => "info", "subtype" => "numeric", "unite" => "kWh", "filter" => ["tarification" => "HC"], "calcul" => "#value#/1000", "dashboard" => "line", "mobile" => "line", "xpath" => "//tic#id#/HCHC", "order" => 19),
				"HCHP" => array("name" => __("Index (HP)", __FILE__), "type" => "info", "subtype" => "numeric", "unite" => "kWh", "filter" => ["tarification" => "HC"], "calcul" => "#value#/1000", "dashboard" => "line", "mobile" => "line", "xpath" => "//tic#id#/HCHP", "order" => 20),
				...
				"BBRHCJB" => array("name" => __("Index (heures creuses jours bleus Tempo)", __FILE__), "type" => "info", "subtype" => "numeric", "unite" => "kWh", "filter" => ["tarification" => "EJP"], "calcul" => "#value#/1000", "dashboard" => "line", "mobile" => "line", "xpath" => "//tic#id#/BBRHCJB", "order" => 23),
				"BBRHPJB" => array("name" => __("Index (heures pleines jours bleus Tempo)", __FILE__), "type" => "info", "subtype" => "numeric", "unite" => "kWh", "filter" => ["tarification" => "EJP"], "calcul" => "#value#/1000", "dashboard" => "line", "mobile" => "line", "xpath" => "//tic#id#/BBRHPJB", "order" => 24),
				"BBRHCJW" => array("name" => __("Index (heures creuses jours blancs Tempo)", __FILE__), "type" => "info", "subtype" => "numeric", "unite" => "kWh", "filter" => ["tarification" => "EJP"], "calcul" => "#value#/1000", "dashboard" => "line", "mobile" => "line", "xpath" => "//tic#id#/BBRHCJW", "order" => 25),
				"BBRHPJW" => array("name" => __("Index (heures pleines jours blancs Tempo)", __FILE__), "type" => "info", "subtype" => "numeric", "unite" => "kWh", "filter" => ["tarification" => "EJP"], "calcul" => "#value#/1000", "dashboard" => "line", "mobile" => "line", "xpath" => "//tic#id#/BBRHPJW", "order" => 26),
				"BBRHCJR" => array("name" => __("Index (heures creuses jours rouges Tempo)", __FILE__), "type" => "info", "subtype" => "numeric", "unite" => "kWh", "filter" => ["tarification" => "EJP"], "calcul" => "#value#/1000", "dashboard" => "line", "mobile" => "line", "xpath" => "//tic#id#/BBRHCJR", "order" => 27),
				"BBRHPJR" => array("name" => __("Index (heures pleines jours rouges Tempo)", __FILE__), "type" => "info", "subtype" => "numeric", "unite" => "kWh", "filter" => ["tarification" => "EJP"], "calcul" => "#value#/1000", "dashboard" => "line", "mobile" => "line", "xpath" => "//tic#id#/BBRHPJR", "order" => 28),
